...
def energy():
    ...
    headers = ['duration_seconds', 'cpu0_package_joules', 'cpu0_core_joules', 'cpu0_dram_joules', 'video', 'schema']
    data = []
    ...
    for dir in os.listdir("./energy"):
        ...
        for file in os.listdir(dir_path):
            ...
            video = file.replace(".mp4.txt", ".mp4")
            ...
            for line in lines:
                ...
                if line.startswith('cpu0_package_joules'):
                    ...
                    data.append([duration_seconds, package_joules, core_joules, dram_joules, video, dir])
